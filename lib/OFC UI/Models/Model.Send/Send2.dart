            ...
            children: [
                      ...
                      children: List.generate(
                        3, // Total number of dots
                          ...
                          decoration: BoxDecoration(
                            color: index < 2 ? myColor : HexColor('#8B8B8BBF'),
                          ),
                        ),
                      ),
                    ),
              ...
              Padding(
                  ...
                  child: Column(
                      ...
                      ,children:[ Text('To',style: TextStyle(fontSize: 24.sp,color: myColor),),
                    SizedBox(height: 8.h,),

                    Text('Choose The Card You Want To Send To',style: TextStyle(fontSize: 16.sp),),
              ...
              Padding(        padding: EdgeInsets.only(left: 20.w,right: 20.w),
                child: Column(
                  ...
                  children: [
                    ...
                    }, text: 'CONFIRM',background: myColor,radius: 12)
                  ],),
              )
